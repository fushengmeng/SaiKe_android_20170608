...
public class QuickCallFragment extends DialogFragment
{
	private QuickCallFragmentListener _listener;
	...
	public QuickCallFragment()
	{
	}
	
	public QuickCallFragment(QuickCallFragmentListener listener)
	{
		_listener = listener;
	}
	...
	{
		this.getDialog().setTitle("专呼电话");
		 
		View v = inflater.inflate(R.layout.fragment_quickcall, null);
		...
		_makeCallButton.setOnClickListener(new OnClickListener()
        {
			...
			public void onClick(View arg0)
			{
				if (null != _listener)
				{
					...
					String strNumber = settings.getString("number"+getSelectedButtonIndex(), "");
					
					_listener.onQuickCallSelect(strNumber);
					
					QuickCallFragment.this.dismiss();
				}
			}
		});
	...
	private void showEditQuickCallDialog() {
		...
		View contentView = LayoutInflater.from(this.getActivity()).inflate(
				R.layout.dialog_edit_quickcall, null);
		final TextView numberTextView = (TextView)contentView.findViewById(R.id.numberTextView);
		...
		ImageButton button00 = (ImageButton)contentView.findViewById(R.id.number00button);
		button00.setOnClickListener(new OnClickListener() 
		{
			@Override
			public void onClick(View arg0)
			{
				if (numberTextView.getText().toString().length() < 5)
				{
		...
		ImageButton button01 = (ImageButton)contentView.findViewById(R.id.number01button);
		...
		ImageButton button02 = (ImageButton)contentView.findViewById(R.id.number02button);
		...
		ImageButton button03 = (ImageButton)contentView.findViewById(R.id.number03button);
		...
		ImageButton button04 = (ImageButton)contentView.findViewById(R.id.number04button);
		...
		ImageButton button05 = (ImageButton)contentView.findViewById(R.id.number05button);
		...
		ImageButton button06 = (ImageButton)contentView.findViewById(R.id.number06button);
		...
		ImageButton button07 = (ImageButton)contentView.findViewById(R.id.number07button);
		...
		ImageButton button08 = (ImageButton)contentView.findViewById(R.id.number08button);
		...
		ImageButton button09 = (ImageButton)contentView.findViewById(R.id.number09button);
		...
		Button deleteNumberButton = (Button)contentView.findViewById(R.id.deleteNumberButton);
		deleteNumberButton.setOnClickListener(new OnClickListener() 
		{
			@Override
			public void onClick(View arg0)
			{
				if (numberTextView.getText().toString().length() > 0)
				{
					String text = numberTextView.getText().toString();
				    numberTextView.setText(text.substring(0, text.length()-1));
				}
			}
		});
		
		dialog.setTitle("设置专呼号码");
		...
		dialog.setPositiveButton("确定", new DialogInterface.OnClickListener()
		{
			...
			public void onClick(DialogInterface arg0, int arg1) 
			{
				...
				editor.putString("number"+getSelectedButtonIndex(), numberTextView.getText().toString());
				editor.commit();
			}
		});
