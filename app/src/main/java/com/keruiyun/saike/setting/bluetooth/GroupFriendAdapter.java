package com.keruiyun.saike.setting.bluetooth;
...
public class GroupFriendAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.item_bluetooth_group_info, null);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.item_bluetooth_friend_info, null);
        ...
        if(friendInfo.isPair()){
            friendViewHolder.statusTv.setText(context.getString(R.string.device_pair));
        } else{
//            friendViewHolder.statusTv.setText(context.getString(R.string.device_offline));
        }
        return convertView;
