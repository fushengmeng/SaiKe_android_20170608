...
public class TimeSettingDialogActivity extends BaseActivity 
{
	...
	public static TimeSettingDialogActivityListener _listener = null;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.dialog_timer_setting);
		...
		_okButton.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View arg0)
			{
				if (null != _listener)
				{
					_listener.timeSettingDialogActivityDidSave(dp, np1, np3, np4);
				}
