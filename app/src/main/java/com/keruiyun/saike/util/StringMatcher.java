...
public class StringMatcher {
	...
	private final static char KOREAN_UNICODE_START = '1';
	private final static char KOREAN_UNICODE_END = '2';
	private final static char KOREAN_UNIT = '2';
	private final static char[] KOREAN_INITIAL = { 'a', 'b', 'c', 'd', 'e',
			'f', 'g', 'h', 'i', 'j', 'k', 'h', 't', 'b', 'z', 't', 'q', 's',
			'w' };
