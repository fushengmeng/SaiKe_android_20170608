...
public class AnalogClockView extends RelativeLayout{
	...
	private void init(Context con){
		...
		mHourHand.setScaleType(ScaleType.FIT_CENTER);
		...
		mMinuteHand.setScaleType(ScaleType.FIT_CENTER);
		lp = new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
		lp.addRule(CENTER_IN_PARENT);
		...
		mSecondHand.setScaleType(ScaleType.FIT_CENTER);
		lp = new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
		lp.addRule(CENTER_IN_PARENT);
	...
	private void proceed(){
		if (!isRunning)
			return;
		TimeZone tz = TimeZone.getDefault(); //TimeZone.getTimeZone(TIMEZONE_ID);
		...
		{
			hour = MainApplication.getInstance().hour;
			min = MainApplication.getInstance().minute;
