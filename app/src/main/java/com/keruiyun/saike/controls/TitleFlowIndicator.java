...
public class TitleFlowIndicator extends TextView implements FlowIndicator {
	...
	public TitleFlowIndicator(Context context, AttributeSet attrs) {
		...
		String customTypeface = a.getString(R.styleable.TitleFlowIndicator_TitleFlowIndicator_customTypeface);
		// Retrieve the colors to be used for this view and apply them.
		int footerColor = a.getColor(R.styleable.TitleFlowIndicator_TitleFlowIndicator_footerColor, FOOTER_COLOR);
		footerLineHeight = a.getDimension(R.styleable.TitleFlowIndicator_TitleFlowIndicator_footerLineHeight, FOOTER_LINE_HEIGHT);
		footerTriangleHeight = a.getDimension(R.styleable.TitleFlowIndicator_TitleFlowIndicator_footerTriangleHeight, FOOTER_TRIANGLE_HEIGHT);
		int selectedColor = a.getColor(R.styleable.TitleFlowIndicator_TitleFlowIndicator_selectedColor, SELECTED_COLOR);
		boolean selectedBold = a.getBoolean(R.styleable.TitleFlowIndicator_TitleFlowIndicator_selectedBold, SELECTED_BOLD);
		int textColor = a.getColor(R.styleable.TitleFlowIndicator_TitleFlowIndicator_textColor, TEXT_COLOR);
		float textSize = a.getDimension(R.styleable.TitleFlowIndicator_TitleFlowIndicator_textSize, TEXT_SIZE);
		float selectedSize = a.getDimension(R.styleable.TitleFlowIndicator_TitleFlowIndicator_selectedSize, textSize);
		titlePadding = a.getDimension(R.styleable.TitleFlowIndicator_TitleFlowIndicator_titlePadding, TITLE_PADDING);
		clipPadding = a.getDimension(R.styleable.TitleFlowIndicator_TitleFlowIndicator_clipPadding, CLIP_PADDING);
