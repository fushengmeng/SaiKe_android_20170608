...
public class ViewFlow extends AdapterView<Adapter> {
	...
	private boolean forbidSlip = false;
	/**
	...
	public ViewFlow(Context context, AttributeSet attrs) {
		...
		mSideBuffer = styledAttrs.getInt(
				R.styleable.ViewFlow_ViewFlow_sidebuffer, 3);
		init();
	}
