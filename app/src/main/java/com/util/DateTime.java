...
public class DateTime {
    ...
    public static final String DEFHM = "HH:mm";
    ...
    public static String getStringByFormat(long date) {

        return getStringByFormat(new Date(date),DEFYMDHMS);
    }

    /**
     * 描述："yyyy-MM-dd HH:mm:ss"类型转化为时间戳.
     *
     * @param timeStr  yyyy-MM-dd HH:mm:ss
     *
     * @return 时间戳
     */
    public static long getLongByFormat(String timeStr) {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(DateTime.DEFYMDHMS);
        Date date = null;
        try {
