...
public class Constants {
    ...
    //刷新播放列表
    public static final String ACTION_REFRESH_LIST = "com.example.musicplayer.list";
    //清空播放列表
    public static final String ACTION_CLEAR = "com.example.musicplayer.clear";
    //本地歌曲listview点击
    ...
    //取消监听
    public static final String ACTION_CANCEL_MSG = "com.example.musicplayer.canclemsg";
    ...
    public static final int MSG_REFRESH_MUSICList = 005;
    public static final int MSG_REFRESH_MUSIC_Position = 006;
    ...
    public static final String KEY_player_status="isplayer";
    public static final String KEY_player_CurrentPosition="CurrentPosition";
